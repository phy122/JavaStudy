...
//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
//클래스
//public class 클래스명
//클래스명 = 파일명 (이름이 같아야한다.)
...
public class Ex01_기본구조 {
	...
	//변수 선언
	//값을 초기화하지 않고 선언
	int energy;  //int 자료형은 값을 초기화하지 않았을 때, 기본 값 0으로 초기화
