...
public class CalendarEx2 {
	...
	public static void main(String[] args) {
		...
		String bofore18Day = sdf.format(cal.getTime());
		System.out.println("18일 전 : " + bofore18Day);
		
		// 50일 전
		cal.add(cal.DAY_OF_WEEK, -50);
		String bofore50Day = sdf.format(cal.getTime());
		System.out.println("50일 전 : " + bofore50Day);
		
		Calendar cal2 = Calendar.getInstance();
		// 50일 전(roll)
		cal2.roll(cal.DAY_OF_WEEK, -50);
		String bofore50Day2 = sdf.format(cal2.getTime());
		System.out.println("50일 전 : " + bofore50Day2);
