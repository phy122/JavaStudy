...
public class ZonedDateTimeEx {
	...
	public static void main(String[] args) {
		...
		ZonedDateTime seuolDateTime = ZonedDateTime.now(ZoneId.of("Asia/Seoul"));
		System.out.println("서울 세계시 : " + seuolDateTime);
		...
		//윤년
		// 1년 : 365.25일이라서, 0.25*4=1일을 매 4년마다 추가해서 사용
