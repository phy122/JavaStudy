...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		// 1970년 1월 1일 0시 0분 0초 0ms 부터 현재 날짜/시간까지 카운트한 숫자를 반환
		// 0.001초		: 1ms
		// 60초			: 1분
		// 60분			: 1시간
		// 24시			: 1일
		...
		birth.set(1999, Calendar.JANUARY, 22);
	...
	private static void printCalendar(String msg, Calendar cal) {		
		...
		System.out.println(hourOfDay + "시 " + minute + "분 " + second + "초 " + millisecond + "밀리초");
