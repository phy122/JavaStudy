...
public class FileManager {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (menuNo) {
				case 1:
					// 디렉토리 생성
					makeDiractory(filePath);
					break;
				case 2:
					// 디렉토리 파일 목록
					listDiractory(filePath);
					break;
				case 3:
					// 파일 정보 조회
					fileInfo(filePath);
	 ...
	 * @param filePath
	 */
	private static void makeDiractory(String filePath) {
		// 파일 객체 생성 방법
	 ...
	 * @param filePath
	 */
	private static void listDiractory(String filePath) {
